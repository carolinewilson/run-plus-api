...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { exercise: @day.exercise, exercise_id: @day.exercise_id, plan_id: @day.plan_id, position: @day.position } }, as: :json
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { exercise: @day.exercise, exercise_id: @day.exercise_id, plan_id: @day.plan_id, position: @day.position } }, as: :json
    assert_response 200
  end
